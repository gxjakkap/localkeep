			...
			<FieldSet className="w-full max-w-md">
				<FieldGroup>
					...
					<Field orientation="horizontal">
						...
						<ButtonGroup>
							<Input id="number-of-gpus-f6l" value={gpuCount} onChange={handleGpuInputChange} size={3} maxLength={3} />
							<Button
								variant="outline"
								size="icon"
								type="button"
							...
							<Popover>
								...
								<PopoverContent align="end" className="w-96">
									...
									<div className="text-sm *:[p:not(:last-child)]:mb-2">
										<Textarea placeholder="Describe your task in natural language." className="min-h-32 resize-none" />
									</div>
								</PopoverContent>
							</Popover>
						</ButtonGroup>
			...
			<div className="flex flex-col gap-6">
				...
				<InputGroup>
					...
					<InputGroupAddon align="block-end">
						...
						<InputGroupButton variant="default" className="style-lyra:rounded-none rounded-full" size="icon-xs">
							<ArrowUpIcon />
